...
Routes output .txt files into language-specific subdirectories based on filename
suffixes (_HE.pdf → hebrew/, _RU.pdf → russian/).

Usage:
    python src/app/extract_medical_pdfs.py
"""
