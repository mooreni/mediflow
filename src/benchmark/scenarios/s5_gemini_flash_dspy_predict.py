"""Scenario 5: Gemini Flash DSPy Predict — Hebrew → Russian translation.

Zero-shot translation using dspy.Predict backed by Gemini Flash via the
...
class GeminiFlashDSPyPredictScenario(TranslationScenario):
    """Translation scenario using Gemini Flash with dspy.Predict (zero-shot)."""
    ...
    def name(self) -> str:
        ...
        """
        return "s5_gemini_flash_dspy_predict"
    ...
    def description(self) -> str:
        ...
        """
        return "Gemini Flash DSPy Predict — zero-shot Hebrew→Russian via dspy.Predict"

    def translate(self, doc: DatasetDoc) -> TranslationResult:
        """Translate a single document using dspy.Predict with Gemini Flash.
        ...
        if not translation:
            raise ValueError(
                f"Empty translation returned by Gemini Flash DSPy Predict for doc "
